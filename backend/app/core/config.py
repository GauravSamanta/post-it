...
class Settings:
    def __init__(self, **kwargs):
        ...
        self.DESCRIPTION: str = os.getenv(
            "DESCRIPTION", "A production-ready FastAPI application for post-it notes"
        )
        ...
        self.DATABASE_URL: str = os.getenv(
            "DATABASE_URL", "postgresql+psycopg2://postgres:rishi@localhost:5432/app"
        )
        ...
        self.FIRST_SUPERUSER_PASSWORD: str = os.getenv(
